const amplifyConfig = {
  ...
  data: {
    url: import.meta.env.VITE_APPSYNC_GRAPHQL_URL,
    aws_region: import.meta.env.VITE_APPSYNC_REGION,
    default_authorization_type: import.meta.env.VITE_APPSYNC_AUTH_TYPE,
    authorization_types: [
      import.meta.env.VITE_APPSYNC_ALT_AUTH_TYPE || 'AMAZON_COGNITO_USER_POOLS',
    ],
    model_introspection: {
      version: 1,
      models: {
        Todo: {
          ...
          fields: {
            ...
            content: { name: 'content', isArray: false, type: 'String', isRequired: false, attributes: [] },
